        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
          ...
          <div className="flex justify-end items-center py-2 border-b border-gray-100">
            <div className="flex items-center space-x-4 sm:space-x-6">
              ...
              >
                <div className="flex items-center justify-center w-4 h-4 bg-green-500 rounded-full mr-2 flex-shrink-0">
              ...
              >
                ...
                <span className="hidden md:inline">contact@super-iptv.nl</span>
              </a>
            </div>
          </div>
