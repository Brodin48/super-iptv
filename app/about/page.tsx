...
export const metadata: Metadata = {
  title: 'About IPTV Baba - Premium IPTV Service Provider',
  description: 'Learn about IPTV Baba - the leading provider of IPTV subscriptions with 25,000+ channels and premium streaming quality since 2019.',
  keywords: 'about IPTV Baba, IPTV Baba company, IPTV provider, premium IPTV service, IPTV Baba history'
}
...
export default function About() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Your IPTV Baba subscription is protected with enterprise-grade security and 99.9% uptime."
    },
    {
      icon: <Users className="w-12 h-12 text-primary-600" />,
      title: "Customer First",
      description: "Our IPTV Baba service includes 24/7 premium support to ensure your streaming experience is perfect."
    }
  ]
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            About <span className="text-blue-300">IPTV Baba</span>
          </h1>
          <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed">
            Your trusted provider of premium IPTV subscriptions, delivering exceptional 
            streaming experiences since 2019 with the best IPTV service in the industry.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">
              Our IPTV Baba Journey
            </h2>
            
            <div className="prose prose-lg mx-auto text-gray-600">
              <p className="text-xl leading-relaxed mb-8">
                Since 2019, IPTV Baba has been at the forefront of revolutionizing home entertainment 
              ...
              <p className="text-lg leading-relaxed mb-8">
                Our IPTV Baba platform has grown to serve over 100,000 satisfied customers worldwide, 
              ...
              <p className="text-lg leading-relaxed">
                Today, IPTV Baba stands as the premier destination for IPTV subscriptions, 
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-16">
            Why Choose Our IPTV Baba Service?
          </h2>
